	...
	<tbody>
		...
		<tr>
			...
			<td valign="top">
				...
				<p>Activity: create a flyout or dropdown menu. When you are done, compare it to the examples given by <a href="https://codepen.io/svinkle/pen/aEVwWd">The A11y Project</a> or Heydon Pickering's <a href="https://inclusive-components.design/menus-menu-buttons/">Inclusive Components</a>. How would you make yours responsive?</p>
			</td>
		</tr>
		<tr>
